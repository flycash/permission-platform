...
// Source: github.com/ecodeclub/ecache (interfaces: Cache)
//
// Generated by this command:
//
//	mockgen -package cachemocks -destination ./mocks/ecache.mock.go github.com/ecodeclub/ecache Cache
//
...
import (
	...
	ecache "github.com/ecodeclub/ecache"
...
func (m *MockCache) Get(ctx context.Context, key string) ecache.Value {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, key)
	ret0, _ := ret[0].(ecache.Value)
	return ret0
}
...
func (m *MockCache) GetSet(ctx context.Context, key, val string) ecache.Value {
	m.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) GetSet(ctx, key, val any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) IncrByFloat(ctx, key, value any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCache) LPop(ctx context.Context, key string) ecache.Value {
	m.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) LPush(ctx, key any, val ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, key}, val...)
...
func (mr *MockCacheMockRecorder) SAdd(ctx, key any, members ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) SRem(ctx, key any, members ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, key}, members...)
...
func (mr *MockCacheMockRecorder) Set(ctx, key, val, expiration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) SetNX(ctx, key, val, expiration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
