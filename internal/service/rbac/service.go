...
type Service interface {
	...
	ListResources(ctx context.Context, bizID int64, resourceType, key string, offset, limit int) ([]domain.Resource, int, error)
	...
	ListPermissions(ctx context.Context, bizID int64, resourceType, resourceKey, action string, offset, limit int) ([]domain.Permission, int, error)
	...
	ListRoles(ctx context.Context, bizID int64, roleType string, offset, limit int) ([]domain.Role, int, error)
	...
	ListUserPermissions(ctx context.Context, bizID, userID int64, offset, limit int) ([]domain.UserPermission, int, error)
}
...
func (s *rbacService) CreateBusinessConfig(ctx context.Context, config domain.BusinessConfig) (domain.BusinessConfig, error) {
	return s.repo.CreateBusinessConfig(ctx, config)
}
...
func (s *rbacService) ListResources(ctx context.Context, bizID int64, resourceType, key string, offset, limit int) ([]domain.Resource, int, error) {
	// 调用仓储层获取资源列表
	return s.repo.FindResourcesByBizIDAndTypeAndKey(ctx, bizID, resourceType, key, offset, limit)
}
...
func (s *rbacService) ListPermissions(ctx context.Context, bizID int64, resourceType, resourceKey, action string, offset, limit int) ([]domain.Permission, int, error) {
...
func (s *rbacService) ListRoles(ctx context.Context, bizID int64, roleType string, offset, limit int) ([]domain.Role, int, error) {
...
func (s *rbacService) ListUserPermissions(ctx context.Context, bizID, userID int64, offset, limit int) ([]domain.UserPermission, int, error) {
